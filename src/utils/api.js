...
export const addMyRecipe = async (userID, recipeID, index, currentDate, navigation) => {
...
export const updateMyRecipe = async (ID, userID, recipeID, index, currentDate, navigation) => {
